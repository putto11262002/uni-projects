...
class EditableImage {
    ...
    /** The file where the combined image is stored. */
    private String combinedFilename;
    /** The macro used to record and reply operations */
    static Macro macro;
     ...
     * @throws Exception If something goes wrong.
     */
    public void saveAs(String imageFilename, String extension) throws Exception {
        this.imageFilename = imageFilename;
        this.opsFilename = imageFilename + ".ops";
        ImageIO.write(original, extension, new File(imageFilename+"."+extension));
        save();
    }

    /**
     * <p>
     * Exports an image to a specific folder.
     * </p>
     * 
     * <p>
     * Exports an image to a specific folder with a name that the user chooses.
     * It applies all the operations to the image before exporting.
     * These operations then become unchangeable so this is the final step of image editing
     * </p>
     * 
     * @param imageFilename The file name give by the user in the save dialog of JFileChooser.
     * @throws Exception If something goes wrong.
     */
    public void export (String imageFilename, String extension) throws Exception {
        this.imageFilename=imageFilename;
        this.combinedFilename=imageFilename+"."+extension;
        ImageIO.write(current, extension, new File(combinedFilename));
    }
    /**
     * <p>
